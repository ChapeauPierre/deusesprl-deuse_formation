...
urlpatterns = api_urlpatterns + [
    ...
    path('celery/progress/<uuid:task_id>/', deuse_formation.celery.celery_progress, name='celery_progress'),
    path('celery/download/<uuid:task_id>/', deuse_formation.celery.celery_download, name='celery_download')
]
